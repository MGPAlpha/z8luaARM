...
static inline z8::fix32 operator/(z8::fix32 x, int y) { return x / z8::fix32(static_cast<int32_t>(y)); }
static inline z8::fix32 operator+(int x, z8::fix32 y) { return z8::fix32(static_cast<int32_t>(x)) + y; }

static inline bool operator==(z8::fix32 x, int y) { return x == z8::fix32(static_cast<int32_t>(y)); }
static inline bool operator <(z8::fix32 x, int y) { return x  < z8::fix32(static_cast<int32_t>(y)); }
static inline bool operator <(int x, z8::fix32 y) { return z8::fix32(static_cast<int32_t>(x))  < y; }
